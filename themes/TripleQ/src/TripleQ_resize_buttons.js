...
resize_buttons.buttons.b0001 = new _button(window.Width - resize_button_size_surround , resize_button_size_surround - resize_button_size, resize_button_size, resize_button_size, {normal : img_folder + 'Resizebutton.png', hover : img_folder + 'Midimode.png'}, (x, y, mask) => {resizeit(1);}, '');
resize_buttons.buttons.b0002 = new _button(window.Width - resize_button_size_surround * 2,     resize_button_size_surround - resize_button_size, resize_button_size, resize_button_size, {normal : img_folder + 'Resizebutton.png', hover : img_folder + 'Minimode.png'},      (x, y, mask) => {resizeit(2);}, '');
