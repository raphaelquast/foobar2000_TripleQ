...
oTopBar = function () {
	...
	this.setButtons = function () {
		...
		gb.DrawString(String.fromCharCode(8855), gdi_font(g_font_wd2.Name, g_font_wd2.Size - g_z6, 0), blendColors(color_bg, color_txt, 0.75), 0, 0, bt_w, bt_h, cc_stringformat);
